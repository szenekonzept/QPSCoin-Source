...
uint256 hashGenesisBlock("0x92e2ff7a26ca55daabcfed198fe19c5eb2dea511edf30589d35d38a551a87776");
...
{
    // QPSCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // QPSCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // QPSCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // QPSCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x92e2ff7a26ca55daabcfed198fe19c5eb2dea511edf30589d35d38a551a87776");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1395842575;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085485903;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("QPSCoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running QPSCoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
